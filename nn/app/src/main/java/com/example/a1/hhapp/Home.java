...
public class Home extends AppCompatActivity
    ...
    FirebaseRecyclerAdapter<Category, MenueViewHolder> adapter;
...
//    FirebaseRecyclerOptions<Category> cat =
    ...
    private void loadMenue() {
        ...
        FirebaseRecyclerOptions<Category> options =
                new FirebaseRecyclerOptions.Builder<Category>()
                        ...
                        .build();
        adapter = new FirebaseRecyclerAdapter<Category, MenueViewHolder>(options) {
            @Override
            public MenueViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.menu_item, parent, false);

                return new MenueViewHolder(view);
            }
